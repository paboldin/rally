...
CTX = "rally.plugins.openstack.context.vm.servers_ext"
...
class ServerGeneratorExtTestCase(test.ContextTestCase):
    ...
    @mock.patch("%s.vm_utils.VMScenario._generate_random_name" % CTX)
    def test__get_server_group(self, mock_vm_scenario__generate_random_name):
        context = {
            "task": mock.Mock(),
            "config": {
                "servers_ext": {
        ...
        mock_vm_scenario__generate_random_name.return_value = "fooname"

        server_generator = servers_ext.ServerGeneratorExt(context)
        retval = server_generator._get_server_group(mock_clients)

        mock_vm_scenario__generate_random_name.assert_called_once_with(
    ...
    def _get_context(self, servers_with_ips, config_override={}):
        ...
        server_generator.boot_one_server_with_ips = mock.Mock(
    ...
    def test__boot_tenant_servers(self):
        ...
        self.assertEqual(
            ...
            server_generator.boot_one_server_with_ips.mock_calls)
    ...
    def test_boot_one_server_with_ips(self, addresses, fip, expected):
        context = {
            "task": mock.Mock(),
        }
        ...
        retval = server_generator.boot_one_server_with_ips(foo_arg="foo_value")
